...
module.exports = {
  ...
  // List > Create > Edit Permissions > Custom Settings
  PERMIGROUP_CUSTOM_ROLE: '自定义权限',
  PERMISSION_CUSTOM_ROLE_BASE: '基础权限',
  PERMISSION_CUSTOM_ROLE_BASE_DESC: '包含大部分无需管控的权限，每个用户都需要',
  PERMISSION_CUSTOM_ROLE_CONFIGMAPS_MANAGE: '配置字典管理权限',
  PERMISSION_CUSTOM_ROLE_CONFIGMAPS_MANAGE_DESC: '允许查看配置详情和操作',
  PERMISSION_CUSTOM_ROLE_CONFIGMAPS_VIEW: '配置字典列表查看权限',
  PERMISSION_CUSTOM_ROLE_CONFIGMAPS_VIEW_DESC: '允许创建和查看配置列表，不需要查看详情',
  PERMISSION_CUSTOM_ROLE_SECRETS_VIEW: '保密字典列表查看权限',
  PERMISSION_CUSTOM_ROLE_SECRETS_VIEW_DESC: '允许创建和查看保密列表，不需要查看详情',
  PERMISSION_CUSTOM_ROLE_SECRETS_MANAGE: '保密字典管理权限',
  PERMISSION_CUSTOM_ROLE_SECRETS_MANAGE_DESC: '允许查看配置详情和操作',
  PERMISSION_CUSTOM_ROLE_SERVICE_MANAGE: '外部端口操作权限',
  PERMISSION_CUSTOM_ROLE_SERVICE_MANAGE_DESC: '允许编辑和创建外部访问端口',
};
